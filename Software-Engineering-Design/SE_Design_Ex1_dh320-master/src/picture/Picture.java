 ...
 * internal representation of the image is based on the Color direct colour model.
 */
public class Picture {
   ...
   * @return the color of the pixel-value located at (x,y).
   ...
   * @param color the Color components of the updated pixel-value
   * @throws ArrayIndexOutOfBoundsException if the specified pixel-location is not contained within
   *                                        the boundaries of this picture.
   */
