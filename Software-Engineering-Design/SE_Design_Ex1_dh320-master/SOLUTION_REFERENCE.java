...
/**
 * REFERENCE SOLUTION - Picture Processor
 *
 * This is the complete solution for all tasks.
 * Use this as a reference if you get stuck, but try to solve the problems yourself first!
 *
 * Learning is most effective when you struggle a bit and figure things out on your own.
 * If you're stuck on a particular method:
 * 1. Review the hints in LEARNING_GUIDE.md
 * 2. Try debugging your code
 * 3. Look at the test cases to understand expected behavior
 * 4. Only then peek at the relevant method here
 */
